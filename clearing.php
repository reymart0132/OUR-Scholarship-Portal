...
<head>
  ...
  ?>
    <div class="container shadow-sm slide-in-left shadow-sm mt-4 p-4">
      <div class="row">
        <div class="col-12">
          <form action="clearing2.php" method="POST">
            <h5 class="mt-3">Clearing and Restart of Portal</h5>
            <h6 class="mt-3">Please input the secret code to begin the clearing of portal</h6>
            <input type="text"  class="form-control form-control-sm" value="" placeholder="Please Enter Secret Code" name="sc">
            <small class="text-danger">*Using this module will reset the entire scholarship portal. Make sure that you have created a backup of your reports and databases before proceeding.</small>
            <input type="submit" class="col -12 btn btn-sm btn-danger mt-4" id="mf"  value="Reset Portal" name="submit" >
          </form>
        </div>
      </div>
    </div>
