...
if($_GET['tn']){
  ...
  $template = $pdf->importPage(1);
    ...
    // $pdf->Image("signature/".findUsername($uid).".png", "50","82", "40","12");
    ...
    if(findEGType($_GET['tn'])== "RA 6728 Grant" || findEGType($_GET['tn'])== "CEU Education Foundation Financial  Assistance"|| findEGType($_GET['tn'])== "20/21 Incentive Program"){
      $approve->EGapprovedSO2();
    }else{
      $approve->EGapprovedSO();
    }
  header('Location: deaneg.php');
}else{
