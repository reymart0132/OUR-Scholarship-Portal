    ...
    <div class="container  slide-in-left shadow-sm-sm p-3 p-4">
      <div class="row">
        <div class="form-group col-md-10 shadow-sm mt-4 p-5">
          <form action="editUSpdfmaker.php" method="POST">
            ...
            <select class="form-control form-control-sm"  name = "duration">
              <option value="1st semester  <?php echo getSY2(); ?>">1st semester <?php echo getSY2(); ?></option>
              <option value="2nd semester  <?php echo getSY2(); ?>">2nd semester  <?php echo getSY2(); ?></option>
              <option value="Summer semester  <?php echo getSY2(); ?>">Summer semester  <?php echo getSY2(); ?></option>
              <option value="Entire  <?php echo getSY2(); ?>">Entire  <?php echo getSY2(); ?></option>
              <option value="2nd Semester and Summer <?php echo getSY2(); ?>">2nd Semester and Summer  <?php echo getSY2(); ?></option>
            </select>
            <h6 class="mt-3">Title of the award</h6>
            <input type="int" class="form-control form-control-sm" id="tf"  value="" name="ta" placeholder="Title of the award" required>
