...
<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a href="entgrant" class="nav-item nav-link navitem ml-4 active">Entrance Grant</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <div class="container-fluid mt-3 pt-4 slide-in-left bg-light rounded shadow-sm">
    <div class="row">
        <div class="col-12">
            <h6 class="text-center mb-4">New Application for Entrance Grants</h6>
        </div>
        <?php if (!empty($_GET)) {
            CheckSuccess($_GET['status']);
        }?>
    </div>
      <form action="resource/php/egapp.php" method="POST" class="" enctype="multipart/form-data">
        ...
        <div class="row border-top py-2">
          ...
          <div class="form-group col-md-6">
            <h6 for="studentN">Grant Applied for:</h6>
            <select id="b" name="awardtitle" class="form-control form-control-sm">
              ...
              <option value="2021 Incentive Program">20/21 Incentive Program</option>
        ...
        <div class="row border-top py-2 justify-content-center">
          <div class="form-group col-md-4">
            <h6 class="text-center" for="studentN">PDF File Requirements (For R.A 6728 Grants Only)</h6>
            ...
            <small class="text-muted"> <br />
              ...
              - Do not upload if the grant type is not R.A 6728 Grant</b></em></b></small>
          </div>
