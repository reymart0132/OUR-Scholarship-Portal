...
<head>
  ...
  ?>
    <div class="container shadow-sm slide-in-left shadow-sm mt-4 p-4">
      <div class="row">
        <div class="col-12">
          <form action="freject2.php" method="POST">
            <h5 class="mt-3">Force Rejection of Scholarship</h5>
            <h6 class="mt-3">Please input the transaction number of the scholarship application</h6>
            <input type="text"  class="form-control form-control-sm" value="" placeholder="Please Enter Transaction Number" name="tn">
            <h6 class="mt-3">Please input the Rejection Reason</h6>
            ...
            <small class="text-danger">*Use extra caution when using this module as this will remove the scholarship application.</small>
            <input type="submit" class="col -12 btn btn-sm btn-danger mt-4" id="mf"  value="Implement Force Rejection" name="submit" >
          </form>
        </div>
      </div>
    </div>
