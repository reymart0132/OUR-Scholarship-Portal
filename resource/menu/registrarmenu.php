    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuTransaction">
          <a class="dropdown-item " href="registrardashboard">For Approval - Entrance Scholarship </a>
          <a class="dropdown-item " href="regeg">For Approval - Entrance Grants </a>
          <a class="dropdown-item " href="regus">For Approval - Continuing Scholarship </a>
          <a class="dropdown-item " href="regug">For Approval - University Grants </a>
        </div>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="reports">
          <a class="dropdown-item" href="regesreport.php">Entrance Scholarship Report</a>
          <a class="dropdown-item" href="regusreport.php">Continuing Scholarship Report</a>
          <a class="dropdown-item" href="regegreport.php">Entrance Grants Report</a>
          <a class="dropdown-item" href="regugreport.php">University Grants Report</a>
        </div>
      </li>
      <li class="nav-item dropdown">
