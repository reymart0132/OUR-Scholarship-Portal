...
class usinsert{
    ...
    function __construct($studentnumber=null, $Lastname=null, $Firstname=null, $Middlename=null, $cgrant=null,$pgrant=null, $college=null,$dateapplied=null,$email=null,$course=null, $GWA=null,$transnumber=null,$file,$Status=null,$semester=null) {
      ...
      $this->Status=$Status;
      if($this->file== true){
        $this->filename = "USA".findCourseABV($course).$Lastname.$Firstname.$studentnumber.".pdf";
      }else{
        $this->file = null;
      }
      $this->rof15 = "ROF15".getSemester2().findCourseABV($course).$Lastname.$Firstname.$studentnumber.".pdf";
    }

    public function insertUSApplication(){
        $config = new config;
        $con = $config->con();
        $sql1 = "INSERT INTO `tbl_university_scholarship`(`studentnumber`, `lastname`, `firstname`, `middlename`,`college`,`course`,`scholarshiptype`,`pgrant`, `date_applied`, `filename`, `rof15`,`email`,`transnumber`,`GWA`,`stats`,`ysemester`) VALUES('$this->studentnumber','$this->lastname','$this->firstname','$this->middlename','$this->college','$this->course','$this->awardtitle','$this->pgrant',NOW(),'$this->filename','$this->rof15','$this->email','$this->transnumber',$this->GWA,'$this->Status','$this->semester')";
