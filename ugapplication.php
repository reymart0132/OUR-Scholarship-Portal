        ...
        <div class="row border-top pt-2">
          ...
          <div class="form-group col-md-4">
            ...
            <select id="b" name="cgrant" class="form-control">
              <option value="CEU Singers Grant">CEU Singers Grant</option>
              <option value="CEU Concert Band">CEU Concert Band </option>
              <option value="CEU Varsity Grant">CEU Varsity Grant </option>
              <option value="CEU Pep Squad Grant">CEU Pep Squad Grant</option>
              <option value="CEU Folk Dance Troupe">CEU Folk Dance Troupe</option>
              <option value="20/21 Incentive Program">20/21 Incentive Program</option>
              <option value="CEU Alumni Foundation Grant">CEU Alumni Foundation Grant</option>
              <option value="USC Grant">USC Grant</option>
              <option value="USC Officers Grant ">USC Officers Grant </option>
              <option value="Medtech Student Council Grant ">Medtech Student Council Grant</option>
              <option value="Mr. & Ms. CEU Grant">Mr. & Ms. CEU Grant  </option>
