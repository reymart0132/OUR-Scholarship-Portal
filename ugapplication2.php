...
<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a href="unvscholarship" class="nav-item nav-link navitem ml-4 active">University Grant</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <div class="container-fluid mt-3 pt-4 slide-in-left bg-light rounded shadow-sm">
    <div class="row">
        <div class="col-12">
            <h6 class="text-center mb-4">New Application for University Grant (Continuing)</h6>
        </div>
        <?php if (!empty($_GET)) {
            CheckSuccess($_GET['status']);
        }?>
    </div>
      <form action="resource/php/ugapp.php" method="POST" class="" enctype="multipart/form-data">
        <div class="row border-top pt-2">
          ...
          <div class="form-group col-md-4">
            <h6 for="studentN">Grant to be applied</h6>
            <select id="b" name="cgrant" class="form-control">
              <option value="RA 6728 Grant">RA 6728 Grant</option>
              <option value="CEU Education Foundation Financial  Assistance">CEU Education Foundation Financial  Assistance </option>
            </select>
          </div>
        </div>
        ...
        <div class="row border-top py-2">
          ...
          <div class="form-group col-md-4">
            <h6 for="studentN">Previous Scholarship/Grant Enjoyed</h6>
        ...
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td>
                <input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s1rating" name="s1rating" aria-describedby="emailHelp" placeholder="Grade / Rating" required>
            </td>
            <td>
                <input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s1unit" name="s1unit" aria-describedby="emailHelp" placeholder="Unit" required>
            </td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s2rating" name="s2rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s2unit" name="s2unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s3rating" name="s3rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s3unit" name="s3unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s4rating" name="s4rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s4unit" name="s4unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s5rating" name="s5rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s5unit" name="s5unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s6rating" name="s6rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s6unit" name="s6unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s7rating" name="s7rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s7unit" name="s7unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s8rating" name="s8rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s8unit" name="s8unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;"  min="1" max="5" step=".25" class="form-control form-control-sm" id="s9rating" name="s9rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s9unit" name="s9unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          <tr>
          	<td>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s10rating" name="s10rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s10unit" name="s10unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
          ...
          <tr>
          	...
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="5" step=".25" class="form-control form-control-sm" id="s11rating" name="s11rating" aria-describedby="emailHelp" placeholder="Grade / Rating" >
          	</td>
          	<td>
          		<input type="number" style="font-size: 70%;" min="1" max="15" step="1" class="form-control form-control-sm" id="s11unit" name="s11unit" aria-describedby="emailHelp" placeholder="Unit" >
          	</td>
          </tr>
        </table>
        <div class="row border-top py-2 justify-content-center">
          <div class="form-group col-md-4">
            ...
            <input id="file" accept=".pdf" type="file" name="file" onchange="validateSize(this)" required>
